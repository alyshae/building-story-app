...
Building.create([
  {name: "225 Bush St", address: "225 Bush Street, San Francisco, CA", description: "225 Bush Street, originally known as the Standard Oil Building, is a 328-foot, 25-floor office building in the financial district of San Francisco. It was the tallest building in the city from its completion in 1922 until 1925. (Source: https://en.wikipedia.org/wiki/225_Bush_Street)", main_photo: "225bush.jpg"},
  {name: "Contemporary Jewish Museum", address: "736 Mission Street, San Francisco, CA", description: "The Contemporary Jewish Museum (CJM) is a non-collecting museum at 736 Mission Street at Yerba Buena Lane in the South of Market (SoMa) neighborhood of San Francisco, California. The museum, which was founded in 1984, is located in the historic Jessie Street Substation, which was gutted and its interior redesigned by Daniel Libeskind, along with a new addition; the new museum opened in 2008. (Source: https://en.wikipedia.org/wiki/Contemporary_Jewish_Museum)", main_photo: "ctj.jpg"},
  {name: "TransAmerica Pyramid", address: "600 Montgomery Street, San Francisco, CA", description: "The Transamerica Pyramid at 600 Montgomery Street between Clay and Washington Streets in the Financial District of San Francisco, California, is a 48-story postmodern building and the second-tallest skyscraper in the San Francisco skyline. Its height will be surpassed by Salesforce Tower, currently under construction. Designed by architect William Pereira and built by Hathaway Dinwiddie Construction Company, at 853 ft, on completion in 1972 it was the eighth tallest building in the world. (Source: https://en.wikipedia.org/wiki/Transamerica_Pyramid)", main_photo: "pyramid1.jpg"},
  {name: "Sentinel Building/Columbus Tower", address: "916 Kearny Street, San Francisco, CA", description: "Columbus Tower, also known as the Sentinel Building is a mixed-use building in San Francisco, California, completed in 1907. The distinctive copper-green Flatiron style structure is bounded by Columbus Avenue, Kearny Street and Jackson Street, straddling the North Beach, Chinatown, and Financial districts of the city. Much of the building is occupied by film studio American Zoetrope, and the ground floor houses a cafe named after the company. (Source: https://en.wikipedia.org/wiki/Columbus_Tower_(San_Francisco))", main_photo: "flatiron.jpg"},
